...
void avg_estimator(Word16* in, Word16* out, long size, Word16 k){
    ...
    Word32 *y = (Word32*) malloc(sizeof(Word32)* size);
...
void thresholding(Word16* inout, long size, char s_h, Word16 k, Word16 c){
    ...
    Word16 *lambda =(Word16*)malloc(sizeof(Word16)*size); 
    Word16 *abs_sub_dj =(Word16*)malloc(sizeof(Word16)*size); 
    Word16 *avg_dj =(Word16*)malloc(sizeof(Word16)*size); 
