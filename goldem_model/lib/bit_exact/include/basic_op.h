...
Word32 L_mult_uns (unsigned short var1, unsigned short var2); /* Unsigned long mult,           1   */
Word16 negate (Word16 var1);              /* Short negate,        1   */
Word16 extract_h (Word32 L_var1);         /* Extract high,        1   */
Word16 extract_l (Word32 L_var1);         /* Extract low,         1   */
Word16 round_itu (Word32 L_var1);             /* Round,               1   */
...
Word32 L_shlNs(Word32 L_var1, Word16 var2);      /* Long shift left, 2 without sat, 2*/
...
Word16 i_mult(Word16 var1,Word16 var2); /* Integer Mult */
